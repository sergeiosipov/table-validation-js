...
// The exact class that forced the v1.3.2 hotfix: v1.3.1's tagged engine baked a
...
// quoted semver-shaped literal in these files is exactly the v1.3.2 bug shape.
...
if (SPEC_DIR) {
    ...
    if (SPEC_DIR) {
        ...
        // see table-validation-js-impl-spec-v1.3.2.md:349 ("(rules M1–M5)", the subset
...
// what catches a console/*.js edit that stales the pinned integrity hashes
{
    ...
    const block =
        ...
        '         script is pinned to the immutable v1.3.2 tag on jsDelivr with\n' +
    ...
    guide = guide.replace('<!doctype html>',
        ...
        '     v1.3.2 tag on jsDelivr; repo links point at GitHub. Generated by\n' +
