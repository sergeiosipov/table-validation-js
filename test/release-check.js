...
if (SPEC_DIR) {
    ...
    if (SPEC_DIR) {
        ...
        // see table-validation-js-impl-spec-v1.6.0.md:349 ("(rules M1–M5)", the subset
...
// what catches a console/*.js edit that stales the pinned integrity hashes
{
    ...
    const block =
        ...
        '         script is pinned to the immutable v1.6.0 tag on jsDelivr with\n' +
    ...
    guide = guide.replace('<!doctype html>',
        ...
        '     v1.6.0 tag on jsDelivr; repo links point at GitHub. Generated by\n' +
