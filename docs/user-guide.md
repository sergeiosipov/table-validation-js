...
*This guide covers console and library version 1.2.0. Screenshots are generated from the
...
cookbook) and the [console architecture](../table-validation-ui-architecture-v1.2.0.md)
(§11 maps every library capability to its place in the UI) live in this repository; the
[core specification](https://github.com/sergeiosipov/table-validation-spec/blob/v1.2.0/table-validation-core-spec-v1.2.0.md)
