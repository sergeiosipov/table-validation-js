...
cookbook) and the [console architecture](../table-validation-ui-architecture-v1.3.1.md)
(§11 maps every library capability to its place in the UI) live in this repository; the
[core specification](https://github.com/sergeiosipov/table-validation-spec/blob/v1.3.1/table-validation-core-spec-v1.3.1.md)
