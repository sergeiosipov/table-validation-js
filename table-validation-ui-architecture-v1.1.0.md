...
| `inferConfig(table, options)` — `sampleRows`, `name`, `suggestRanges`, `suggestPrecision`, `seedComparison`, `allAcceptingFormats` §3.13 | InferenceBanner options row; evidence table; one-click adoption; Use-draft flow |
