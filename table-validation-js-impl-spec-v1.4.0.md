...
<script src="https://cdn.jsdelivr.net/gh/sergeiosipov/table-validation-js@v1.4.0/dist/table-validation.js"></script>
...
```javascript
const w = new Worker('https://cdn.jsdelivr.net/gh/<owner>/table-validation-js@v1.4.0/dist/table-validation-worker.js');
...
```
https://cdn.jsdelivr.net/gh/sergeiosipov/table-validation-js@v1.4.0/dist/table-validation.js
```
