/*!
 * table-validation v1.3.1 — hand-authored TypeScript declarations for the Browser JS
 * profile (Core Specification v1.3.1 + Authoring, Ingestion & Inference Addendum v1.3.1).
