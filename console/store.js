...
(function (global) {
    ...
    function initialState() {
        return {
            ...
            inference: { status: 'idle', offer: null, options: { sampleRows: 1000, suggestRanges: false, seedComparison: false, allAcceptingFormats: false } },
            run: {
            ...
            inferRun() {
                ...
                try {
                    ...
                    st.inference.offer = TV().inferConfig(t, {
                        ...
                        sampleRows: o.sampleRows, suggestRanges: o.suggestRanges, seedComparison: o.seedComparison,
                        allAcceptingFormats: o.allAcceptingFormats,
                    });
